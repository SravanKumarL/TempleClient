...
export const LOAD_RECENT_LIST = 'LOAD_RECENT_LIST';
...
export const SEARCH_TRANSACTIONS_RESET = 'SEARCH_TRANSACTIONS_RESET';
...
//Native Date Picker
export const ON_NATIVE_SINGLE_DATE_CHANGED = "ON_NATIVE_SINGLE_DATE_CHANGED";
export const ON_NATIVE_RANGE_FROM_DATE_CHANGED = "ON_NATIVE_RANGE_FROM_DATE_CHANGED";
export const ON_NATIVE_RANGE_TO_DATE_CHANGED = "ON_NATIVE_RANGE_TO_DATE_CHANGED";
export const ON_NATIVE_RANGE_NUMBEROFDAYS_DATE_CHANGED = "ON_NATIVE_RANGE_NUMBEROFDAYS_DATE_CHANGED";
export const ON_NATIVE_CHANGE_LIFTED = "ON_NATIVE_CHANGE_LIFTED";
export const NATIVE_SET_DEFAULT_DATE = "NATIVE_SET_DEFAULT_DATE";
export const NATIVE_SOFT_RESET_DATE_PICKER = "NATIVE_SOFT_RESET_DATE_PICKER";
export const NATIVE_HARD_RESET_DATE_PICKER = "NATIVE_HARD_RESET_DATE_PICKER";